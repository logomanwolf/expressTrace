...
public class Calculator {
	...
	public String getLatLngDistance(Point start, Point end) {
		...
		// 接口参数
		String param = "coord_type=gcj02&output=json&origins=" + start.getLat()
				+ "," + start.getLng() + "&destinations=" + end.getLat() + ","
				+ end.getLng() + "&ak=VGDs0twlaDEdMMvD49SM1xp6zZAIWeXD";
		Integer m = EstimateUtils.getEstimatedDistance(url, param);
		Double km = m / 1000d;
